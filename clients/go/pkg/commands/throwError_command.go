...
type ThrowErrorCommandStep2 interface {
	ErrorCode(string) ThrowErrorCommandStep3
}

type ThrowErrorCommandStep3 interface {
...
func (c *ThrowErrorCommand) ErrorCode(errorCode string) ThrowErrorCommandStep3 {
